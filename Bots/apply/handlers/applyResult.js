    ...
    if(interaction.isButton()) {
      if(interaction.customId == "apply_accept") {
        ...
        let adminrole = settings.adminrole;
            ...
            await user2.roles.add(therole).catch(async() => {return interaction.reply({content:`**لم استطع اعطاء الشخص الرتبة , الرجاء التأكد من صلاحيات البوت وان رتبتي فوق الرتبة المقدم عليها**`})})
